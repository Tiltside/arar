...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center mb-4 pb-4 border-bottom">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <small class="text-muted d-md-none">Цена:</small>
                                ...
                                <div class="col-md-2 col-sm-6">
                                    <small class="text-muted d-md-none">Итого:</small>
                                    <span class="h6 text-success"><?= number_format($item['total'], 2, '.', ' ') ?> руб.</span>
                                </div>
                                <div class="col-md-1 col-sm-6 text-center">
                                    <form method="POST" class="d-inline remove-form" data-product-name="<?= htmlspecialchars($item['name']) ?>">
                                        <input type="hidden" name="product_id" value="<?= $item['id'] ?>">
                                        <input type="hidden" name="remove_from_cart" value="1">
                                        <button type="button" class="btn btn-danger remove-item-btn w-100" title="Удалить товар">
    ...
    <script>
        ...
        // Обработка удаления товара с подтверждением
