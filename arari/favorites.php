...
<body>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php if(count($favorite_items) > 0): ?>
                <div class="d-flex gap-2">
                    ...
                    <form method="POST" class="d-inline" id="clear-favorites-form">
                        <input type="hidden" name="clear_favorites" value="1">
                        <button type="button" class="btn btn-outline-danger" id="clear-all-favorites-btn">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card product-card h-100">
                        <div class="card-img-container position-relative">
                            ...
                            <button type="button"
                                    class="btn btn-danger btn-sm position-absolute top-0 end-0 m-2 remove-favorite-btn"
                                    data-remove-url="favorites.php?remove=<?= $item['favorite_id'] ?>"
    ...
    <script>
        // Обработка удаления товара из избранного с подтверждением
        document.querySelectorAll('.remove-favorite-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                showConfirmDialog(
                    ...
                    `Вы уверены, что хотите удалить "${productName}" из избранного?`,
                    () => {
        ...
        // Обработка кнопки "Очистить все" в избранном
        ...
        if (clearAllFavoritesBtn) {
            clearAllFavoritesBtn.addEventListener('click', function() {
                const form = document.getElementById('clear-favorites-form');
                ...
                showConfirmDialog(
                    ...
                    () => {
                        // Отмена - ничего не делаем
                        console.log('Очистка избранного отменена');
                    }
                );
            });
        }
