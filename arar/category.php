    ...
    <main class="container my-5">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="index.php#categories">Категории</a></li>
       ...
       <div class="row mb-5">
    <div class="col-12">
        <div class="category-header text-center py-5 rounded" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
...
<section id="category-products">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <span class="badge bg-primary fs-6">Найдено: <?= count($products) ?> товаров</span>
    </div>
